...
def main() -> None:
    ...
    train_command = [
        ...
        *common_model_args,
        ...
        "--propagation_start_iter",
        "1000",
        "--propagation_until_iter",
        "6000",
        "--propagation_interval",
        "50",
        "--propagation_neighbors",
        "4",
        "--propagation_downsample",
        "4",
        "--propagation_patch_radius",
        "2",
        "--propagation_patchmatch_iterations",
        "3",
        "--propagation_min_consistent_views",
        "2",
        "--propagation_max_anchors_per_step",
        "1024",
        "--gaussianpro_full_min_proposals",
        "100",
        "--gaussianpro_full_discrepancy_start",
        "1.0",
        "--gaussianpro_full_discrepancy_end",
        "0.8",
        "--lambda_gaussianpro_full_flatten",
        "100.0",
        "--lambda_gaussianpro_full_normal_l1",
        "0.001",
        "--lambda_gaussianpro_full_normal_cos",
        "0.001",
    ]
    run(train_command, "TRAIN BONSAI FULL-FORM 7000", cwd=source_dir)
